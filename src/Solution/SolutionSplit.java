...
public class SolutionSplit {
	...
	public static void main(String[] args) {
        ...
        for(int i=0;i<3;i++){
            String s1=sc.next();
            int x=sc.nextInt();
            /* O (%) que significa que se segue é um argumento que será formatado. 
             * Em seguida, segue um (-) resultado no alinhamento esquerdo.
             *  15 preenche a cadeia com até 15 caracteres (adicionando espaços no final). 
             *  Finalmente, os (s) meios que você está formatando uma string.*/
            /* "%03d\n" - Adiciona 0s caso o número tenha menos de 3 casas decimais*/
